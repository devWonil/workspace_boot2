...
public class MyMiniGameWithButton extends JFrame implements ActionListener{
	...
	private void initData() {
		...
		startBtn = new JButton("Left");
		endBtn = new JButton("Right");
